...
//PENDO CHAGE: making the struct with unique name to see we collect it as screenIdentifier 
            ...
            HStack{
                ...
                Button(action: {
                    ...
                    Image(systemName: "mic.fill")
                        ...
                        .padding()
                        .shadow(radius: 10)
                        .background(Color(red: 0.1, green: 0.1, blue: 0.1).opacity(0.001), ignoresSafeAreaEdges: [])
                }
            }
        }
    }
